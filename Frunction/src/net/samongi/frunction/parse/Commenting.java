...
public class Commenting
{
  ...
  private static final String INLINE_COMMENT_REGEX = INLINE_COMMENT_STR_OPEN
      + ".*" + INLINE_COMMENT_STR_CLOSE;
  ...
  /**
   * Replaces all Line based comments. Line based comments are defined as all
   * text between a hash and a newline character
   * 
   * @param text
   * @return
   */
