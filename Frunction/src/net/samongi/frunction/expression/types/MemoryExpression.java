...
/**Used to remember the frunction output from an expression
 * This generally encapsulates other expressions after they have
 * been parsed.  This does not really break any expressions but
 * should introduce memoization
 * 
 * @author Alex
 *
 */
