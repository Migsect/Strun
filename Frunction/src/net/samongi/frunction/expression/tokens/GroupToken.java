  ...
  public void evaluate() throws TokenException
  {
    ...
    while(i < this.source.length())
    {
      ...
      if(ParseUtil.matchesAt(source, i, InputToken.OPEN))
      {
        ...
        if(!ParseUtil.matchesAt(section, section.length() - InputToken.CLOSE.length(), InputToken.CLOSE)) { throw new TokenException(section); // Throwing the exception
        }
      ...
      if(ParseUtil.matchesAt(source, i, FrunctionToken.OPEN))
      {
        ...
        if(!ParseUtil.matchesAt(section, section.length() - FrunctionToken.CLOSE.length(), FrunctionToken.CLOSE)) { throw new TokenException(section); // Throwing the exception
        }
