...
public interface Token
{
  ...
  {
    return new String[] { StringFrunction.STRING_CAPSULE };
  }
  ...
  /** Parses the string trying to find tokens If multiple tokens are found, it will return a group token.
   * 
   * @param source
   * @return
   * @throws TokenError */
  ...
  /** Returns the source of this token The source will be a string that the token is generated from. This will not
   * include identifiers for the token such as parens for input tokens.
   * 
   * @return */
  public String getSource();

  /** Returns the type of the token. This can be used with just the class but this is more official
   * 
   * @return */
