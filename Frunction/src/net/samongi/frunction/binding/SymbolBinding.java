...
{
  /**
   * Returns the key of the symbol binding This key will be the string that it
   * is accessed with
   * 
  ...
  /**
   * Returns the privacy state of the binding. This determines if the key can be
   * accessed from outside of its container
   * 
  ...
  /**
   * This will collapse the symbol to have its expression forced to evaluate to
   * a frunction.
   */
  public void collapse() throws TokenException;

  /**
   * Returns a frunction that this symbol may be representing. This will force a
   * collapse as well as an evaluation of symbol binding.
   * 
   * @return
   */
