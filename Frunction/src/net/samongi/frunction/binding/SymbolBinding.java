...
public class SymbolBinding
{
	...
	public static SymbolBinding parseBinding(String text_section, Container environment)
	{
	...
	public SymbolBinding(String key, String source, Container environment)
	{
		this.key = key;
		this.source = source;
		this.environment = environment;
	}
	public SymbolBinding(String key, DynamicFrunction evaluated, Container environment)
	{
	  this.key = key;
