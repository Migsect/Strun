...
public class FileUtil
{
	public static String readFile(File file)
	{
		...
		try{return FileUtil.readFile(file_path);}
		catch(IOException e){return null;}
	}
	public static String readFile(String file_path) throws IOException {return FileUtil.readFile(file_path, Charset.defaultCharset());}
