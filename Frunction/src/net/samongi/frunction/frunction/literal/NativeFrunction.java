...
{
  /**
   * Will attempt to parse a symbol and try to forulate a literal from it. This
   * will return null if it could not forumate a frunction fro the symbol.
   * 
   * @param symbol
   *          The symbol to parse
   * @param environment
   *          The environment that the frunction will be made in
